 ...
 * $.alert("Message content", "Title");
 * For position, please use:
 * top-left, top-right, bottom-left, bottom-right, center (both uppercase and lowercase are allowed)
 */
...
(function ($) {
    $.alert_ext = {
        ...
        defaults: {
            ...
            closeTime: 5000,   // Auto close time, not less than 1000
            withTime: false, // Add timer  Will add ...10 after the text
            type: 'danger',  // Message type
            position: ['center', [-0.42, 0]], // Position, the first entry is the position (in English), followed by the offset; if between 1 and -1, it represents a percentage
            title: false, // Title
            close: '',   // Must bind the button to close the event
            speed: 'normal',   // Speed
            isOnly: true, // Whether to only show one
