...
$residents_summary = $db
	...
	->select([
		...
		"under_age" => "SUM(residents.age < 18)",
		"adult" => "SUM(residents.age >= 18)",
	])
	->exec();
...
$admin_dashboard_cards = [
    ...
    "icon" => "fas fa-child",
    "title" => "Under Age",
    "subtitle" => "Total Under Age Residents",
    "value" => number_format($residents_summary["under_age"]),
    "href" => "resident.php?age=under",
],
[
    "icon" => "fas fa-user",
    "title" => "Adults",
    "subtitle" => "Total Adult Residents",
    "value" => number_format($residents_summary["adult"]),
    "href" => "resident.php?age=adult",
],
...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Barangay Poblacion Profiling System</title>
