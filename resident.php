...
<head>
  ...
  <title>Resident Information - Barangay Poblacion Profiling System</title>
</head>
                  ...
                  <div class="col-md-4">
                    ...
                    <?php if (isAuthenticated()): ?>
                      <div class="form-group d-flex justify-content-center">
                        <button type="button" class="btn btn-primary btn-sm mr-2" id="open_cam1">Open Camera</button>
